//
//  IncomeConvenienceMenusTest.swift
//  achievementsUITests
//
...
class IncomeConvenienceMenuTest: XCTestCase {
    ...
    func testBookingUniqueIncomeFromIncomesMenu() throws {
        let app = XCUIApplication()
        
        /* Add Unique Income Template */
        // Dashboard
        ...
        app.toolbars["Toolbar"].buttons["incomeTemplates"].press(forDuration: 1)
    ...
    func testBookingRecurringIncomeFromIncomesMenu() throws {
        let app = XCUIApplication()
        
        /* Add Recurring Income Template */
        // Dashboard
        app.toolbars["Toolbar"].buttons["incomeTemplates"].tap()
